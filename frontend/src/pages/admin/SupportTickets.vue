<template>
  <div class="bgbody">
    <div class="container">
      <div class="row">
        <div class="col">
          <h1 class="text-white"><center>Support Ticket</center></h1>
        </div>
      </div>
      <div class="row">
        <div class="col" style="margin-bottom: 10px">
          <h3 class="text-white mb-2">Filter by ticket status</h3>
          <br /><br />
          <button
      ...
      <div class="row">
        <div class="col">
          ...
          >
            ...
            <tbody>
              <tr v-for="ticket in filteredTickets" :key="ticket.id">
                ...
                <td class="align-middle">{{ ticket.createdAt }}</td>
          ...
          <p v-else class="text-white" style="font-size: 150%">
            No Tickets To View
          </p>
        </div>
      </div>
  ...
  computed: {
    filteredTickets() {
      if (this.filterStatus === "new") {
        ...
        return this.tickets; // No filter applied
      }
    },
  },
  methods: {
    ...
    deleteTicket(ticketId) {
      // Implement delete ticket functionality
